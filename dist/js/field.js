...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-ajax-call', __webpack_require__(3));
    Vue.component('detail-ajax-call', __webpack_require__(11));
    Vue.component('form-ajax-call', __webpack_require__(14));
});
...
var update = __webpack_require__(7)("7333d52a", content, false, {});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        go: function go() {
            ...
            this.executed = true;
            this.loading = true;
            Nova.request().get(this.field.link, {
  ...
  return _c("span", { staticClass: "relative" }, [
    _c(
      "a",
      {
        ...
        staticStyle: { "line-height": "1.95rem" },
        attrs: { href: "#" },
        on: {
    ...
    _c(
      ...
      [
        _c(
          "svg",
          {
            staticClass: "w-6 h-6 svg-icon-error",
            attrs: { viewBox: "0 0 20 20" }
          },
          [
            _c("path", {
        ...
        _c(
          "a",
          {
            staticClass: "text-xs inline-block ml-1",
            attrs: { href: _vm.field.link, target: "_blank" }
          },
          [_vm._v("Run Manually")]
        )
      ]
    ...
    _c(
      "div",
      {
        ...
        staticClass:
          "absolute rotating text-80 flex justify-center items-center pin-y mr-3"
      },
      [
        _c(
          "svg",
